# 🍎 FRUIT DROPPER - v2.0
## Quick Shortcut ##
1. [PENJELASAN SISTEM CUSTOM BACKGROUND](FRUIT_DROPPER_DOCUMENTATION.md)
2. [PENJELASAN/RINGKASAN PERBAIKAN v2.0](IMPROVEMENTS_SUMMARY.md)
3. [PENJELASAN ISI/KONTEN GAME](INDEX.md)
